...
<body class="h-full">
  <div class="min-h-full">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/" class="rounded-md text-gray-300 hover:bg-gray-700  px-3 py-2 text-sm font-medium"
                  aria-current="page">Home</a>
                <a href="/about.php"
                  class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About</a>
                <a href="/contact.php"
                  class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium  hover:text-white">Contact</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
    ...
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1>You Are On The Contact Page!</h1>
      </div>
    </main>
  </div>
